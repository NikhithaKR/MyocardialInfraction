...
# Loading model
with open(r"C:\Users\Admin\OneDrive\Desktop\project\Classification.pkl", 'rb') as f:
...
def main():
    ...
    df = pd.read_csv(r"C:\Users\Admin\OneDrive\Desktop\project\Input file format.csv")
    ...
    with open(r"C:\Users\Admin\OneDrive\Desktop\project\Input file info.txt", 'r', encoding='utf-8') as file:
        content = file.read()
